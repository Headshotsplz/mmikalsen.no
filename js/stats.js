...
(function () {
  ...
  const T = {
    no: {
      ...
      tiles: { matches: 'Kamper', sets: 'Sett', points: 'Poeng', attack: 'Angrepspoeng', block: 'Blokkpoeng', ace: 'Serveess' },
    ...
    en: {
      ...
      tiles: { matches: 'Matches', sets: 'Sets', points: 'Points', attack: 'Attack points', block: 'Block points', ace: 'Aces' },
