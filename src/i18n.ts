...
const no = {
  ...
  current: {
    ...
    top: 'Toppscorer',
    noPlayerStats: 'Spillerstatistikk er ikke lagt ut ennå.',
    showFixtures: (n: number) => `Vis terminliste (${n} kamper)`,
    showTable: 'Vis tabell',
    cols: {
      player: 'Spiller',
      matches: 'Kamper',
...
const en: Dict = {
  ...
  current: {
    ...
    pointsWord: 'points',
    next: 'Next match',
    leaders: 'Points leaders',
    results: 'Results',
    showPlayers: 'Show players',
    top: 'Top scorer',
    noPlayerStats: 'Player statistics have not been published yet.',
    showFixtures: (n: number) => `Show fixtures (${n} matches)`,
    showTable: 'Show table',
    cols: {
      player: 'Player',
      matches: 'Matches',
